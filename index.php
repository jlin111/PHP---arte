...
<head>
    ...
    <title>PHP - Compiti Pasqua</title>
</head>
...
<div>
    ...
    <div id="titolo">
        <form  method="POST">
            <label for="username"><h1>Scegli una QUERY da visualizzare:</h1> </label> 
            <input type="text" id="input" name="input" default="" placeholder="inserisci">
        </form>
    </div>
    <ul id="lista">
        <li id="lista_li">Il titolo delle opere del Tiziano conservate al museo “El Prado”. </li>
        <li id="lista_li">L’elenco degli artisti ed il titolo delle loro opere conservate alla “Galleria degli Uffi-zi” o a “Palazzo Pitti” </li>
        <li id="lista_li">L’elenco degli artisti e delle loro opere conservate nei musei di Firenze</li>
        <li id="lista_li">Le città in cui sono conservate opere di Leonardo</li>
        <li id="lista_li">L’elenco delle opere del Tiziano conservate nei musei di Londra </li>
        <li id="lista_li">L’elenco degli artisti e il titolo delle opere di artisti spagnoli conservate nei musei di Firenze</li>
        <li id="lista_li">L’elenco dei titoli delle opere di artisti italiani conservate nei musei di Londra, in cui è rappresentata la Madonna</li>
        <li id="lista_li">Il nome dei musei di Londra che conservano opere di Picasso </li>
        <li id="lista_li">Il nome e il loro autore delle opere che rappresentano “Gesù e San Giovannino” </li>
        <li id="lista_li">L’elenco dei nomi degli artisti che hanno dipinto “Gesù e San Giovannino”</li>
        <li id="lista_li">Il nome e l’autore delle opere che rappresentano “Gesù e San Giovannino” oppure “la Madonna e Giovanni Battista” </li>
        <li id="lista_li">L’elenco delle opere ed il loro autore che rappresentano “San Giovanni” al museo del Prado </li>
    </ul>
</div>
